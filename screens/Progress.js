  ...
  async componentDidMount() {
    ...
    fetch("http://InsertYourIpHere:1337/entries?userId=" + id, {
      ...
      .then(responseJson => {
        ...
        //this.setState({ tagMap: tagMap });
        var highestwater = Math.max.apply(Math, this.state.listEntries.map(function (o) { return o.water; }));
        var higheststeps = Math.max.apply(Math, this.state.listEntries.map(function (o) { return o.steps; }));
        var highestweight = Math.max.apply(Math, this.state.listEntries.map(function (o) { return o.weight; }));
        var highestsleep = Math.max.apply(Math, this.state.listEntries.map(function (o) { return o.hours_of_sleep; }));
        console.log("Last Water: " + highestwater);
        console.log("Last Steps: " + higheststeps);
        console.log("Last Weight: " + highestweight);
        console.log("Last Sleep: " + highestsleep);
      })
      .catch(error => {
        console.error(error);
      });
