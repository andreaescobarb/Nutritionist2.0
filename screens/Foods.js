    ...
    return (
      <Block flex style={styles.group}>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          <Picker
            selectedValue={parameters.description}
            onVaueChange={(itemValue, itemIndex) =>
              (parameters.description = itemValue)
            }
          >
    ...
    return foods.map(food => {
      return (
        <Card
          ...
          image={{
            uri:
              "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fcdn-image.foodandwine.com%2Fsites%2Fdefault%2Ffiles%2Fstyles%2Fmedium_2x%2Fpublic%2Fbuying-healthy-foods-ft-blog0617.jpg"
          }}
        >
          <Text style={{ marginBottom: 5 }}>{food.description}</Text>
          <Tags
